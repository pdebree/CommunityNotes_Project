...
We also remove notes that have `isMediaNote` - meaning that the note is based on the media in the tweet - not the text. This makes these notes not useful in our analysis because our evaluations will all be text based. 
...
```
   ...
   10.0    41.0    77.0   149.2   149.0 22272.0 
